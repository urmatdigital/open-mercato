...
const buildWarrantyClaimsCrudOpenApi = createCrudOpenApiFactory({
  defaultTag: 'Warranty Claims',
...
export function createWarrantyClaimsCrudOpenApi(options: CrudOpenApiOptions): OpenApiRouteDoc {
  return buildWarrantyClaimsCrudOpenApi(options)
}
