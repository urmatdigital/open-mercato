...
const buildEudrCrudOpenApi = createCrudOpenApiFactory({
  defaultTag: 'EUDR',
...
export function createEudrCrudOpenApi(options: CrudOpenApiOptions): OpenApiRouteDoc {
  return buildEudrCrudOpenApi(options)
}
