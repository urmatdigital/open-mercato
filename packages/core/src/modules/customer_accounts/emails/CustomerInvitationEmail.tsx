...
export type CustomerInvitationEmailCopy = {
  preview: string
  title: string
  body: string
  cta: string
...
export type CustomerInvitationEmailProps = {
  inviteUrl: string
  copy: CustomerInvitationEmailCopy
}

export function CustomerInvitationEmail({ inviteUrl, copy }: CustomerInvitationEmailProps) {
  return (
    <Html>
      <Head />
