...
export type ExistingAccountEmailCopy = {
  preview: string
  heading: string
  greeting: string
  body: string
...
export default function ExistingAccountEmail({ loginUrl, copy }: ExistingAccountEmailProps) {
  return (
    <Html>
      <Head>
      ...
      <Body style={{ backgroundColor: '#f1f5f9', fontFamily: 'Helvetica, Arial, sans-serif', padding: '24px 0' }}>
        <Container style={{ backgroundColor: '#ffffff', padding: '32px', borderRadius: '12px', margin: '0 auto', maxWidth: '520px' }}>
          ...
          <Text style={{ fontSize: '14px', color: '#64748b', marginBottom: '16px', lineHeight: '22px' }}>{copy.ignore}</Text>
