...
| + | **Process subject + caseload projection** — case-anchored `AgentProcess` read-model + `subject` reference backing the "Processes" / "Process detail" pages (needs #2; Phase B needs the workflows-lifecycle prerequisite below) | [`next/2026-06-25-agent-process-subject-and-caseload-projection.md`](./next/2026-06-25-agent-process-subject-and-caseload-projection.md) | — |
