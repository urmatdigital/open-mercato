...
|---|------|--------------------|--------|
| 1 | [`2026-07-12-ux-p0-hotfixes.md`](./2026-07-12-ux-p0-hotfixes.md) — **✅ implemented 2026-07-12** (commits `73b87cd9b`, `41ad6a23a`, `c243a4569`) | P0-1…P0-6: route rename + guard test, Processes ACL meta flip, stub-action disable, delete confirmations ×3, Overview fabricated section → Sample chip + domain-chip removal, Caseload inbox pager | S |
