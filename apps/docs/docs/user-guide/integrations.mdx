...
- [Custom Webhooks](./webhooks) — enable the webhook integration, create endpoints, copy signing secrets, and inspect delivery logs.
...
- [Official Modules](../framework/modules/official-modules) — browse and install community-built integration modules, or publish your own custom integration for other Open Mercato users.
